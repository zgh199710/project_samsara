...
from samsara.utils import get_local_file, cache_dir, get_file
from samsara.transforms import Compose, Flatten, ToFloat, Normalize
...
class MNIST(Dataset):
    ...
    def prepare(self):
        ...
        data_path = get_local_file(files['target'])
        label_path = get_local_file(files['label'])
